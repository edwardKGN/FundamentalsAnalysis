...
class financialData_sectorFinance(FA_Valuation_gen.valuation_gen, FA_Profitability_gen.profitability_gen, FA_Efficiency_gen.efficiency_gen, FA_Liquidity_gen.liquidity_gen, FA_sub_dividendPaying.dividendPaying, FA_sub_haveSales.haveSales, FA_sub_inventoryHolding.inventoryHolding, fundamentalsAnalysis.financialData_main):
